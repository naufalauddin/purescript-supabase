...
import Supabase.Supabase (class Equals, class Select, AuthResponse, Count(..), CountR, CountResponse, DataR, ErrorR, FilterBuilder, FunctionResponse, QueryBuilder, Response, ResultError, Session, SessionData, StatusR, User, delete, equals, from, getSession, invoke, maybeSingle, onAuthStateChange, range, select, signInWithOtp, signOut, single, update, upsert, signUpWithEmail)
